<template>
    <div class="add-container">
        <div class="header">
            ...
            <p>Modification de Catégories</p>
        </div>
        ...
        <form @submit.prevent="submitForm">
            <div class="wrapper-fields">
                ...
                <div class="select-container">
                    <select id="langue" v-model="category.language" required>
            ...
            <div class="wrapper-fields">
                ...
                <input placeholder="Entrer un nom" v-model="category.name" type="text" id="name" required />
            </div>
            ...
            <div v-if="!isLoading" class="btn-wrapper">
                ...
                <router-link to="/categories"><button class="cancel-btn">Annuler</button></router-link>
            </div>
            <div v-else class="btn-wrapper">
                <!-- <span>Catégorie en cours d'enregistrement... Veuillez patienter.</span>-->
    ...
    methods: {
        submitForm() {
            ...
            let data = {
                ...
                language: this.category.language,
            };


            axios
                .put(`https://sika-info-server.vercel.app/categories/${this.$route.params.id}`, data, {
                ...
                .catch((error) => {
                    ...
                    this.message = "Une erreur est apparue lors de l'enregistrement de la catégorie.";
                    this.bgc = "error";
                    this.isVisible = true;
                })
        ...
        fetchCategory() {
            ...
            axios.get(`https://sika-info-server.vercel.app/categories/${this.$route.params.id}`)
                .then((response) => {
                    this.category.language = response.data.language;
