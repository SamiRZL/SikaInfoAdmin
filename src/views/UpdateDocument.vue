    ...
    <div class="add-container">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div v-else class="btn-wrapper">
                <!-- <span>Document en cours d'enregistrement... Veuillez patienter.</span>-->
    ...
    methods: {
        submitForm() {
            ...
            if (this.document.pdf) {
                data.pdf = this.document.pdf;
            }

            axios
                .put(`https://sika-info-server.vercel.app/documents/${this.$route.params.id}`, data, {
                ...
                .then(() => {
                    ...
                    this.message = "Document modifié avec succès!";
                    this.bgc = "success";
                    this.isVisible = true;
                })
                .catch((error) => {
                    console.error("Error submitting blog post", error);
                    this.message = "Une erreur est apparue lors de l'enregistrement du document.";
                    this.bgc = "error";
                    this.isVisible = true;
                })
        ...
        fetchDocument() {
            ...
            axios.get(`https://sika-info-server.vercel.app/documents/${this.$route.params.id}`)
                .then((response) => {
                    this.document.category = response.data.data.category._id;
                    this.document.aspect = response.data.data.aspect._id;
                    this.document.language = response.data.data.language;
                    this.document.title = response.data.data.title;
                    this.document.pdf = response.data.data.pdf
