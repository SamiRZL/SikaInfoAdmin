...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios
                .post("https://sika-info-server.vercel.app/aspects", data, {
                ...
                .then(() => {
                    ...
                    this.aspect.language = "";


                    // Set success message and display it
                    this.message = "Aspect ajouté avec succès!";
                    this.bgc = "success";
                    this.isVisible = true;
                })
                .catch((error) => {
                    console.error("Error submitting blog post", error);
                    this.message = "Une erreur est survenue lors de l'ajout de l'aspect.";
                    this.bgc = "error";
                    this.isVisible = true;
                })
